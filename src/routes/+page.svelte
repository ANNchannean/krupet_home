...
<svelte:head>
  <title
    >ប្រព័ន្ធគ្រប់គ្រងមន្ទីរពេទ្យ | លេខាពេទ្យ - lekhapet</title
  >
  <meta
    name="description"
    content="ប្រព័ន្ធគ្រប់គ្រងមន្ទីរពេទ្យ lekhapet ជាកម្មវិធីឌីជីថលសម្រាប់គ្រប់គ្រងអ្នកជំងឺ ឱសថស្ថាន មន្ទីរពិសោធន៍ បំណុល និងសេវាកម្មសុខភាពទាំងអស់នៅកម្ពុជា។ សូមស្វាគមន៍សាកល្បងឥតគិតថ្លៃ។"
  />
  <meta
    name="keywords"
    content="ប្រព័ន្ធគ្រប់គ្រងមន្ទីរពេទ្យ, ប្រព័ន្ធគ្រប់គ្រងមន្ទីពេទ្យ, hospital management system, HMS, កម្មវិធីមន្ទីរពេទ្យ, គ្រប់គ្រងអ្នកជំងឺ, ឱសថស្ថាន, មន្ទីរពិសោធន៍, បំណុលពេទ្យ, សុខភាពកម្ពុជា, lekhapet, ការចុះឈ្មោះអ្នកជំងឺ, កំណត់ត្រាវេជ្ជសាស្រ្ត"
  />
